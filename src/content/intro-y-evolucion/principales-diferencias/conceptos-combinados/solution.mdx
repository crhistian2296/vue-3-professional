...
- Cambió de Options API a Composition API
...
**Vue 3:**
```typescript
// Opción 1: Computed property (recomendado)
const formattedMessage = computed(() => {
  return addPrefix(capitalize(message.value))
})
...
4. **Composition API**: Lógica más reutilizable
5. **v-bind CSS**: Estilos dinámicos más eficientes
6. **Mejor DX**: Autocompletado y detección de errores

### Conceptos aplicados

- ✅ **Filters → Computed/Functions**: Migración completa
- ✅ **Template Refs**: `ref<HTMLElement>()`
- ✅ **Watchers**: `watch()` con tipado
- ✅ **Class/Style Bindings**: Computed properties + v-bind CSS
